...
#define GMVAR_LEN( aArray ) (sizeof( aArray )/sizeof(gm::GMVARIABLE))
...
#define GM_ARGS GMVARIABLE argument[]=
#define GM_NORMAL_RESULT gm::GMVARIABLE result;
#define GM_VAR_RESULT gm::CGMVariable retval(false);gm::GMVARIABLE result;ZeroMemory(&result,sizeof(result))
...
#define GM_RETURN_REAL return result.valueReal
#define GM_RETURN_INT return(int)result.valueReal
#define GM_RETURN_BOOL return(bool)(((int)result.valueReal)&1)
